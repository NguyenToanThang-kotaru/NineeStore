    ...
    if (index >= start && index < end) {
      ...
      if (item.Detail.Sale > 0) {
        ...
        <span class= "product-price">${(
          tmp * item.Price.replace(/\./g, "")
        ).toLocaleString("vi-VN")}</span><sup class="sale-price">₫</sup>
              ...
              <div class="detail-title">
                ...
                <div class="detail-prices">
                  ...
                  <span class="detail-sale-price">${(
                    ...
                    "vi-VN"
                  )}</span><sup class="sale-price">₫</sup>
                </div>
                <div class="product-quantity">Kho: <span class="product-quantity-value">${
                  item.Quantity
                }</span></div>
                <div class="detail-quantity">
                  <i class="fa-solid fa-circle-minus desc-quantity" onclick="decreaseQuantity(this)"></i>
                  <div class="detail-quantity-value">1</div>
                  <i class="fa-solid fa-circle-plus plus-quantity" onclick="increaseQuantity(this,${
                    item.Quantity
                  })"></i>
                </div>
